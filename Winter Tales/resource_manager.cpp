...
void ResourceManager::load()
{
	...
	flip_image("magic_bear_attack_1_left", "magic_bear_attack_1_right", 6);
	flip_image("magic_bear_attack_2_left", "magic_bear_attack_2_right", 6);
	flip_image("magic_bear_attack_3_left", "magic_bear_attack_3_right", 6);
	flip_image("magic_bear_attack_4_left", "magic_bear_attack_4_right", 4);
	flip_image("magic_bear_idle_left", "magic_bear_idle_right", 4);
	flip_image("magic_bear_hurt_left", "magic_bear_hurt_right", 2);
	flip_image("magic_bear_dead_left", "magic_bear_dead_right", 4);
	flip_image("magic_bear_walk_left", "magic_bear_walk_right", 6);
	flip_image("magic_bear_sneer_left", "magic_bear_sneer_right", 6);
